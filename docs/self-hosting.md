...
```bash
# Clone Pigeon P2P repo
$ git clone https://github.com/MoonBaseDAO/pigeon-app.git
# Go to pigeon-app dir
$ cd pigeon-app
...
Check if is correctly installed: https://your.domain.name.or.ip:3000
...
```bash
# Pigeon P2P - HTTPS — proxy all requests to the Node app
server {
	# Enable HTTP/2
...
Check Your Pigeon P2P instance: https://your.domain.name

---

## Update script

In order to have always Your Pigeon P2P updated to latest, we going to create a script
...
git pull
docker-compose down
docker pull pigeon-app/p2p:latest
...
Follow the commits of the Pigeon P2P project [here](https://github.com/MoonBaseDAO/pigeon-app/commits/master)

To update Your Pigeon P2P instance at latest commit, execute:
